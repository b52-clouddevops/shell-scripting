...
COMPONENT=$1 
ENV=$2
HOSTED_ZONE_ID="Z09483701TR0NQUW1KZ5B"
...
SG_ID=$(aws ec2 describe-security-groups --filters Name=group-name,Values=b51-allow-all --region us-east-1 | jq .SecurityGroups[].GroupId | sed -e 's/"//g')
